  ...
  function createData([atmName, INSUFFICIENT_FUNDS, INCORRECT_PIN, CODE_400_DESC, HOST_TX_TIMEOUT,WITHDRAWAL_LMT_EXCEEDED,CONTACT_ISSUER,PIN_TRIES_EXCEEDED_CAP,NO_ACCOUNT,CODE_907_DESC,EXPIRED_CARD_CAP,E,NO_ARPC,POWER_INTERRUPTION,WITHDRAWAL,BALANCE_INQUIRY,FAST_CASH_WITHDRAWAL]) {
    return { atmName, INSUFFICIENT_FUNDS, INCORRECT_PIN, CODE_400_DESC, HOST_TX_TIMEOUT,WITHDRAWAL_LMT_EXCEEDED,CONTACT_ISSUER,PIN_TRIES_EXCEEDED_CAP,NO_ACCOUNT,CODE_907_DESC,EXPIRED_CARD_CAP,E,NO_ARPC,POWER_INTERRUPTION,WITHDRAWAL,BALANCE_INQUIRY,FAST_CASH_WITHDRAWAL};
  }
